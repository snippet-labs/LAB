...
const Cards = ({
  ...
  return (
    <div className="relative group bg-white/5 backdrop-blur-md border border-neutral-800 rounded-2xl p-6 w-full lg:w-[720px] shadow-lg transition transform hover:scale-[1.02] hover:shadow-xl hover:cursor-pointer">
      <div className="mb-4">
        <div
